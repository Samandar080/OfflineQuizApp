...
//    private int totalTimeInMins = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView backBtn = findViewById(R.id.bacBtn);
...
//        quizTimer.cancel();
    ...
    private void revealAnswer() {
        ...
        if (option1.getText().toString().equals(getAnswer)) {
            option1.setBackgroundResource(R.drawable.round_bac_green10);
            option1.setTextColor(Color.WHITE);
        } else if (option2.getText().toString().equals(getAnswer)) {
            option2.setBackgroundResource(R.drawable.round_bac_green10);
            option2.setTextColor(Color.WHITE);
        } else if (option3.getText().toString().equals(getAnswer)) {
            option3.setBackgroundResource(R.drawable.round_bac_green10);
            option3.setTextColor(Color.WHITE);
        } else if (option4.getText().toString().equals(getAnswer)) {
            option4.setBackgroundResource(R.drawable.round_bac_green10);
            option4.setTextColor(Color.WHITE);
        }
    }
}